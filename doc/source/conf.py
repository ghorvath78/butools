...
latex_documents = [
  ('index', 'butools.tex', u'butools Documentation',
   u'Gabor Horvath', 'manual'),
]
...
man_pages = [
    ('index', 'butools', u'butools Documentation',
     [u'Gabor Horvath'], 1)
]
...
texinfo_documents = [
  ('index', 'butools', u'butools Documentation',
   u'Gabor Horvath', 'butools', 'One line description of project.',
   'Miscellaneous'),
]
