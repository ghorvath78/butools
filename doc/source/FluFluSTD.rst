butools.queues.FluFluSTD
========================

.. currentmodule:: butools.queues

.. np:function:: FluFluSTD

    .. list-table::
        :widths: 25 150

        * - Matlab:
          - :code:`[alpha, A] = FluFluSTD (Qin, Rin, Qout, Rout, srv0stop, transToPH, prec)`
        * - Mathematica:
          - :code:`{alpha, A} = FluFluSTD [Qin, Rin, Qout, Rout, srv0stop, transToPH, prec]`
        * - Python/Numpy:
          - :code:`alpha, A = FluFluSTD (Qin, Rin, Qout, Rout, srv0stop, transToPH, prec)`
    ...
    >>> Rout = diag([1 7 15]);
    >>> [alpha, A] = FluFluSTD(Qin,Rin,Qout,Rout,false);
    >>> MomentsFromME(alpha,A,5)
           0.1948      0.11287      0.10069      0.12158      0.18506
    >>> x=(0:0.05:1)';
    >>> y=PdfFromME(alpha,A,x);
    >>> plot(x,y);
    >>> [alpha, A] = FluFluSTD(Qin,Rin,Qout,Rout,false,true);
