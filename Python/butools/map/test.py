...
def TestMAPPackage ():
    ...
    assert len(corr)==3 and all(corr<1) and all(corr>-1), "LagCorrelationsFromMAP returned wrong autocorrelation coefficients!"
    ...
    assert len(corr)==3 and all(corr<1) and all(corr>-1), "LagCorrelationsFromRAP returned wrong autocorrelation coefficients!"
...
#    rNm3=rNm{3}
#    
#    assert norm(moms-rmoms)<1e-10 and norm(Nm1-rNm1)<1e-10 and norm(Nm2-rNm2)<1e-10 and norm(Nm3-rNm3)<1e-10, "The moments and joint moments returned by MRAPFromMoments are not the same as given!")
#    
#    print("----------------------------------------------------------------------------")
...
#    assert norm(moms-rmoms)<1e-12 and norm(corr-rcorr)<1e-12, "The moments and the correlation returned by MAP2FromMoments are not the same as given!")
#    
#    print("----------------------------------------------------------------------------")
...
#    assert norm(rmoms-moms)<1e-12 and norm(rcorr1-corr1)<1e-12, "MAPFromFewMomentsAndCorrelations failed to match the marginal moments or the lag-1 autocorrelation!")
#    
#    print("Input:")
#    print("------")
#    
...
#    assert size(H0,1)==3 and err<1e-12, "MinimalRepFromRAP returned a RAP which is non-similar to the input or has an unexpected size!")
#    
...
#    
#    assert CheckRAPRepresentation(H0,H1), "MinimalRepFromRAP did not return a valid RAP representation!")
#    assert size(H0,1)==2 and err<1e-12, "MinimalRepFromRAP returned a RAP which is non-similar to the input or has an unexpected size!")
#    
...
#    assert size(H{1},1)==3 and err<1e-12, "MinimalRepFromMRAP returned a MRAP which is non-similar to the input or has an unexpected size!")
#    
...
#    
#    assert CheckMRAPRepresentation(H), "MinimalRepFromMRAP did not return a valid MRAP representation!")
#    assert size(H{1},1)==2 and err<1e-12, "MinimalRepFromMRAP returned a MRAP which is non-similar to the input or has an unexpected size!")
#    
