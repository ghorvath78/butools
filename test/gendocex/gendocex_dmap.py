...
outFile = open('/home/gabor/github/butools/test/docex/DMAP_python.docex','w')
with redirect_stdout(outFile):
    ...
    print('>>>     Nx = LagkJointMomentsFromDMAP(D0, D1, 1, i)')
    ...
    cjm = np.zeros(3)
    print('>>> for i in range(1,4,1):')
    print('>>>     Nx = LagkJointMomentsFromDRAP(H0, H1, 1, i)')
    print('>>>     cjm[i-1] = (Nx[1, 1]-moms[0]**2)/(moms[1]-moms[0]**2)')
    for i in range(1,4,1):
    ...
    print('>>> print(rNm3)')
    print(rNm3)
    print('>>> print(la.norm(np.array(moms)-np.array(rmoms)))')
