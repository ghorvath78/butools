...
Module[{moms, cdf, tmpOut, x, mb, stream, a, mp, pmf, ma, Cm, err2, err1, phmoms, ev, flag, b, A, B, memoms},
	Unprotect[Print];
	...
	On[Assert];
	tmpOut = $Output;
	stream = OpenWrite["DPH_mathematica.docex", FormatType -> InputForm, PageWidth -> Infinity];
	$Output = {stream};
	Print["=== MomentsFromMG ==="//OutputForm];
	...
	Print[">>> Print[moms];"//OutputForm];
	Print[moms];
	Print["=== MomentsFromDPH ==="//OutputForm];
	...
	Print[">>> Print[moms];"//OutputForm];
	Print[moms];
	Print["=== PmfFromMG ==="//OutputForm];
	Print[">>> a = {-0.6, 0.3, 1.3};"//OutputForm];
	a = {-0.6, 0.3, 1.3};
	Print[">>> A = {{0.25, 0.2, -0.15},{0.3, 0.1, 0.25},{0, 0.2, 0.47}};"//OutputForm];
	A = {{0.25, 0.2, -0.15},{0.3, 0.1, 0.25},{0, 0.2, 0.47}};
	Print[">>> x = Range[0,100,1];"//OutputForm];
	x = Range[0,100,1];
	Print[">>> pmf = PmfFromMG[a,A,x];"//OutputForm];
	pmf = PmfFromMG[a,A,x];
	Print[">>> ListLinePlot[Transpose[{x, pmf}]]"//OutputForm];
	Print["=== PmfFromDPH ==="//OutputForm];
	Print[">>> a = {0.76, 0, 0.24};"//OutputForm];
	a = {0.76, 0, 0.24};
	Print[">>> A = {{0.34, 0.66, 0},{0.79, 0.05, 0.07},{0.26, 0.73, 0.01}};"//OutputForm];
	A = {{0.34, 0.66, 0},{0.79, 0.05, 0.07},{0.26, 0.73, 0.01}};
	Print[">>> x = Range[0,1000,1];"//OutputForm];
	x = Range[0,1000,1];
	...
	Print[">>> Print[flag];"//OutputForm];
	Print[flag];
	Print["=== MGFromMoments ==="//OutputForm];
	...
	Print[">>> Print[Max[err1,err2]];"//OutputForm];
	Print[Max[err1,err2]];
	Print["=== CanonicalFromDPH3 ==="//OutputForm];
	...
	Print[">>> Print[Max[err1,err2]];"//OutputForm];
	Print[Max[err1,err2]];
	Print["=== AcyclicDPHFromMG ==="//OutputForm];
	...
	Print[">>> Print[Max[err1,err2]];"//OutputForm];
	Print[Max[err1,err2]];
	Print["=== DPH2From3Moments ==="//OutputForm];
	...
	Print[phmoms];
	Print["=== DPH3From5Moments ==="//OutputForm];
	...
	Print[">>> Print[phmoms];"//OutputForm];
	Print[phmoms];
	Print["=== SamplesFromDPH ==="//OutputForm];
	Print[">>> a = {0.76, 0, 0.24};"//OutputForm];
	a = {0.76, 0, 0.24};
	Print[">>> A = {{0.34, 0.66, 0},{0.79, 0.05, 0.07},{0.26, 0.73, 0.01}};"//OutputForm];
	A = {{0.34, 0.66, 0},{0.79, 0.05, 0.07},{0.26, 0.73, 0.01}};
