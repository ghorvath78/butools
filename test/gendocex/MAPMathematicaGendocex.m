...
Module[{rNm1, D, D1, Nm1, err2, mm, moms, G3, Cm, rcorr1, Nm, corr1, G0, H0, Nm2, jmom, D0, G2, rmom, rNm3, tmpOut, lb, H, stream, D3, err1, a, H2, rmoms, A, x, corr, rjmom, ub, H1, D2, Nm3, G, G1, mom, rcorr, rNm2, m, flag, err, rNm},
	...
	On[Assert];
	tmpOut = $Output;
	stream = OpenWrite["MAP_mathematica.docex", FormatType -> InputForm, PageWidth -> Infinity];
	$Output = {stream};
	Print["=== MarginalDistributionFromMAP ==="//OutputForm];
	...
	Print[">>> Print[A];"//OutputForm];
	Print[A];
	Print["=== MarginalMomentsFromMAP ==="//OutputForm];
	Print[">>> D0 = {{-0.17, 0, 0, 0.07},{0.01, -0.78, 0.03, 0.08},{0.22, 0.17, -1.1, 0.02},{0.04, 0.12, 0, -0.42}};"//OutputForm];
	D0 = {{-0.17, 0, 0, 0.07},{0.01, -0.78, 0.03, 0.08},{0.22, 0.17, -1.1, 0.02},{0.04, 0.12, 0, -0.42}};
	Print[">>> D1 = {{0, 0.06, 0, 0.04},{0.04, 0.19, 0.21, 0.22},{0.22, 0.13, 0.15, 0.19},{0.05, 0, 0.17, 0.04}};"//OutputForm];
	D1 = {{0, 0.06, 0, 0.04},{0.04, 0.19, 0.21, 0.22},{0.22, 0.13, 0.15, 0.19},{0.05, 0, 0.17, 0.04}};
	...
	Print[moms];
	Print["=== MarginalDistributionFromRAP ==="//OutputForm];
	...
	Print[">>> Print[A];"//OutputForm];
	Print[A];
	Print["=== MarginalMomentsFromRAP ==="//OutputForm];
	Print[">>> H0 = {{-2., 0, 0},{0, -3., 1.},{0, -1., -2.}};"//OutputForm];
	H0 = {{-2., 0, 0},{0, -3., 1.},{0, -1., -2.}};
	Print[">>> H1 = {{1.8, 0.2, 0},{0.2, 1.8, 0},{0.2, 1.8, 1.}};"//OutputForm];
	H1 = {{1.8, 0.2, 0},{0.2, 1.8, 0},{0.2, 1.8, 1.}};
	...
	Print[">>> Print[moms];"//OutputForm];
	Print[moms];
	Print["=== MarginalDistributionFromMMAP ==="//OutputForm];
	...
	Print[">>> Print[A];"//OutputForm];
	Print[A];
	Print["=== MarginalMomentsFromMMAP ==="//OutputForm];
	Print[">>> D0 = {{-1.78, 0.29},{0.07, -0.92}};"//OutputForm];
	D0 = {{-1.78, 0.29},{0.07, -0.92}};
	Print[">>> D1 = {{0.15, 0.49},{0.23, 0.36}};"//OutputForm];
	D1 = {{0.15, 0.49},{0.23, 0.36}};
	...
	Print[">>> Print[moms];"//OutputForm];
	Print[moms];
	Print["=== MarginalDistributionFromMRAP ==="//OutputForm];
	...
	Print[">>> Print[A];"//OutputForm];
	Print[A];
	Print["=== MarginalMomentsFromMRAP ==="//OutputForm];
	Print[">>> x = 0.18;"//OutputForm];
	x = 0.18;
	Print[">>> H0 = {{-5., 0.1+x, 0.9, 1.},{1., -8., 0.9, 0.1},{0.9, 0.1, -4., 1.},{1., 2., 3., -9.}};"//OutputForm];
	H0 = {{-5., 0.1+x, 0.9, 1.},{1., -8., 0.9, 0.1},{0.9, 0.1, -4., 1.},{1., 2., 3., -9.}};
	...
	Print[">>> Print[moms];"//OutputForm];
	Print[moms];
	Print["=== LagCorrelationsFromMAP ==="//OutputForm];
	...
	Print[corr];
	Print["=== LagCorrelationsFromRAP ==="//OutputForm];
	Print[">>> H0 = {{-2., 0, 0},{0, -3., 1.},{0, -1., -2.}};"//OutputForm];
	H0 = {{-2., 0, 0},{0, -3., 1.},{0, -1., -2.}};
	Print[">>> H1 = {{1.8, 0.2, 0},{0.2, 1.8, 0},{0.2, 1.8, 1.}};"//OutputForm];
	H1 = {{1.8, 0.2, 0},{0.2, 1.8, 0},{0.2, 1.8, 1.}};
	...
	Print[">>> Print[corr];"//OutputForm];
	Print[corr];
	Print["=== LagkJointMomentsFromMAP ==="//OutputForm];
	Print[">>> D0 = {{-5., 0, 1., 1.},{1., -8., 1., 0},{1., 0, -4., 1.},{1., 2., 3., -9.}};"//OutputForm];
	D0 = {{-5., 0, 1., 1.},{1., -8., 1., 0},{1., 0, -4., 1.},{1., 2., 3., -9.}};
	Print[">>> D1 = {{0, 1., 0, 2.},{2., 1., 3., 0},{0, 0, 1., 1.},{1., 1., 0, 1.}};"//OutputForm];
	D1 = {{0, 1., 0, 2.},{2., 1., 3., 0},{0, 0, 1., 1.},{1., 1., 0, 1.}};
	...
	Print[">>> Print[moms];"//OutputForm];
	Print[moms];
	Print[">>> cjm=Table[(LagkJointMomentsFromMAP[D0,D1,1,i][[2,2]]-moms[[1]]^2) / (moms[[2]]-moms[[1]]^2),{i,1,3}];"//OutputForm];
	...
	Print["=== LagkJointMomentsFromRAP ==="//OutputForm];
	Print[">>> H0 = {{-2., 0, 0},{0, -3., 1.},{0, -1., -2.}};"//OutputForm];
	H0 = {{-2., 0, 0},{0, -3., 1.},{0, -1., -2.}};
	Print[">>> H1 = {{1.8, 0.2, 0},{0.2, 1.8, 0},{0.2, 1.8, 1.}};"//OutputForm];
	H1 = {{1.8, 0.2, 0},{0.2, 1.8, 0},{0.2, 1.8, 1.}};
	...
	cjm={};
	Print[">>> cjm=Table[(LagkJointMomentsFromRAP[H0,H1,1,i][[2,2]]-moms[[1]]^2) / (moms[[2]]-moms[[1]]^2),{i,1,3}];"//OutputForm];
	...
	Print[corr];
	mNm1 = Nm[[1,2;;]]; mNm2 = Nm[[2;;,1]];
	Print["=== LagkJointMomentsFromMMAP ==="//OutputForm];
	Print[">>> D0 = {{-1.78, 0.29},{0.07, -0.92}};"//OutputForm];
	D0 = {{-1.78, 0.29},{0.07, -0.92}};
	Print[">>> D1 = {{0.15, 0.49},{0.23, 0.36}};"//OutputForm];
	D1 = {{0.15, 0.49},{0.23, 0.36}};
	...
	Print[Nm[[3]]];
	Print["=== LagkJointMomentsFromMRAP ==="//OutputForm];
	Print[">>> x = 0.18;"//OutputForm];
	x = 0.18;
	Print[">>> H0 = {{-5., 0.1+x, 0.9, 1.},{1., -8., 0.9, 0.1},{0.9, 0.1, -4., 1.},{1., 2., 3., -9.}};"//OutputForm];
	H0 = {{-5., 0.1+x, 0.9, 1.},{1., -8., 0.9, 0.1},{0.9, 0.1, -4., 1.},{1., 2., 3., -9.}};
	...
	Print[">>> Print[m];"//OutputForm];
	Print[m];
	Print["=== CheckMAPRepresentation ==="//OutputForm];
	...
	Print[">>> Print[flag];"//OutputForm];
	Print[flag];
	Print["=== CheckRAPRepresentation ==="//OutputForm];
	...
	Print[">>> Print[flag];"//OutputForm];
	Print[flag];
	Print["=== CheckMMAPRepresentation ==="//OutputForm];
	...
	Print[">>> Print[flag];"//OutputForm];
	Print[flag];
	Print["=== CheckMRAPRepresentation ==="//OutputForm];
	Print[">>> x = 0.18;"//OutputForm];
	x = 0.18;
	Print[">>> H0 = {{-5., 0.1+x, 0.9, 1.},{1., -8., 0.9, 0.1},{0.9, 0.1, -4., 1.},{1., 2., 3., -9.}};"//OutputForm];
	H0 = {{-5., 0.1+x, 0.9, 1.},{1., -8., 0.9, 0.1},{0.9, 0.1, -4., 1.},{1., 2., 3., -9.}};
	...
	Print[">>> Print[flag];"//OutputForm];
	Print[flag];
	Print["=== RAPFromMoments ==="//OutputForm];
	...
	Print[">>> Print[rNm];"//OutputForm];
	Print[rNm];
	Print["=== MRAPFromMoments ==="//OutputForm];
	...
	Print[rNm3];
	Print["=== RAPFromMomentsAndCorrelations ==="//OutputForm];
	...
	Print[rcorr];
	Print["=== MAP2FromMoments ==="//OutputForm];
	...
	Print[">>> Print[rcorr];"//OutputForm];
	Print[rcorr];
	Print["=== MAP2CorrelationBounds ==="//OutputForm];
	Print[">>> D0 = {{-14., 1.},{1., -25.}};"//OutputForm];
	D0 = {{-14., 1.},{1., -25.}};
	Print[">>> D1 = {{6., 7.},{3., 21.}};"//OutputForm];
	D1 = {{6., 7.},{3., 21.}};
	...
	Print[ub];
	Print["=== MAPFromFewMomentsAndCorrelations ==="//OutputForm];
	...
	Print[">>> Print[err];"//OutputForm];
	Print[err];
	Print["=== MinimalRepFromRAP ==="//OutputForm];
	...
	Print[">>> Print[Max[err1,err2]];"//OutputForm];
	Print[Max[err1,err2]];
	Print["=== MinimalRepFromMRAP ==="//OutputForm];
	Print[">>> D0 = {{-5., 1., 0},{3., -3., 0},{1., 1., -5.}};"//OutputForm];
	D0 = {{-5., 1., 0},{3., -3., 0},{1., 1., -5.}};
	...
	Print[">>> Print[H[[3]]];"//OutputForm];
	Print[H[[3]]];
	Print[">>> Cm = SimilarityMatrix[H[[1]],D[[1]]];"//OutputForm];
	Cm = SimilarityMatrix[H[[1]],D[[1]]];
	Print[">>> err = Norm[H[[1]].Cm-Cm.D[[1]]] + Norm[H[[2]].Cm-Cm.D[[2]]] + Norm[H[[3]].Cm-Cm.D[[3]]];"//OutputForm];
	...
	Print[">>> Print[err];"//OutputForm];
	Print[err];
	Print["=== SamplesFromMAP ==="//OutputForm];
	Print[">>> D0 = {{-0.17, 0, 0, 0.07},{0.01, -0.78, 0.03, 0.08},{0.22, 0.17, -1.1, 0.02},{0.04, 0.12, 0, -0.42}};"//OutputForm];
	D0 = {{-0.17, 0, 0, 0.07},{0.01, -0.78, 0.03, 0.08},{0.22, 0.17, -1.1, 0.02},{0.04, 0.12, 0, -0.42}};
	Print[">>> D1 = {{0, 0.06, 0, 0.04},{0.04, 0.19, 0.21, 0.22},{0.22, 0.13, 0.15, 0.19},{0.05, 0, 0.17, 0.04}};"//OutputForm];
	D1 = {{0, 0.06, 0, 0.04},{0.04, 0.19, 0.21, 0.22},{0.22, 0.13, 0.15, 0.19},{0.05, 0, 0.17, 0.04}};
	...
	Print[mm];
	Print["=== SamplesFromMMAP ==="//OutputForm];
	Print[">>> D0 = {{-1.78, 0.29},{0.07, -0.92}};"//OutputForm];
	D0 = {{-1.78, 0.29},{0.07, -0.92}};
	Print[">>> D1 = {{0.15, 0.49},{0.23, 0.36}};"//OutputForm];
	D1 = {{0.15, 0.49},{0.23, 0.36}};
