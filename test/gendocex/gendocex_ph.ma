...
On[Assert];
tmpOut = $Output;
stream = OpenWrite["/home/gabor/github/butools/test/docex/PH_mathematica.docex", FormatType -> InputForm, PageWidth -> Infinity];
$Output = {stream};
Unprotect[Print];
...
Print[">>> A = {{-1, 0, 0},{0, -3, 2},{0, -2, -3}};"//OutputForm];
A = {{-1, 0, 0},{0, -3, 2},{0, -2, -3}};
Print[">>> x = Range[0.0,5.0,0.01];"//OutputForm];
...
Print[">>> A = {{-6.2, 2, 0},{2, -9, 1},{1, 0, -3}};"//OutputForm];
A = {{-6.2, 2, 0},{2, -9, 1},{1, 0, -3}};
Print[">>> x = Range[0.0,3.0,0.002];"//OutputForm];
...
Print[Max[err1, err2]];
Print["=== MEOrder ==="]
Print[">>> a = {1.0/6,1.0/6,1.0/6,1.0/6,1.0/6,1.0/6};"//OutputForm];
...
Print[mo];
Print[">>> a = {2.0/3,1.0/3};"//OutputForm];
a = {2.0/3,1.0/3};
