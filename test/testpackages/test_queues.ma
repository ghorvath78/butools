...
Assert[Norm[qld-PmfFromMG[alpha, A, Range[0,10,1]]]<1e-12, "QBDQueue: qlDistr returns wrong queue length distribution!"];
Assert[Norm[std-CdfFromME[beta, B, Range[0.,1.,0.1]]]<1e-12, "QBDQueue: stDistr returns wrong sojourn time distribution!"];
...
Assert[Norm[qld-PmfFromMG[alpha, A, Range[0,10,1]]]<1e-12, "MAPMAP1: qlDistr returns wrong queue length distribution!"];
Assert[Norm[std-CdfFromME[beta, B, Range[0.,1.,0.1]]]<1e-12, "MAPMAP1: stDistr returns wrong sojourn time distribution!"];
...
Print["std = "//OutputForm];
Print[std];
Assert[Min[std]>=0&&Max[std]<=1&&AllTrue[Flatten[Differences[std]],#>=0 &,2], "MMAPPH1PRPR: invalid sojourn time distribution!"];
...
Print["std = "//OutputForm];
Print[std];
Assert[Min[std]>=0&&Max[std]<=1&&AllTrue[Flatten[Differences[std]],#>=0 &,2], "MMAPPH1NPPR: invalid sojourn time distribution!"];
lambda1 = 1./MarginalMomentsFromMAP[D0+D2+D3, D1, 1][[1]];
lambda2 = 1./MarginalMomentsFromMAP[D0+D1+D3, D2, 1][[1]];
lambda3 = 1./MarginalMomentsFromMAP[D0+D1+D2, D3, 1][[1]];
...
Assert[Norm[qld-CdfFromME[alpha, A, Range[0.,1.,0.1]]]<1e-12, "FluidQueue: qlDistr returns wrong queue length distribution!"];
Assert[Norm[std-CdfFromME[beta, B, Range[0.,1.,0.1]]]<1e-12, "FluidQueue: stDistr returns wrong sojourn time distribution!"];
...
Assert[Norm[qld-CdfFromME[alpha, A, Range[0.,1.,0.1]]]<1e-12, "FluFluQueue: qlDistr returns wrong queue length distribution!"];
Assert[Norm[std-CdfFromME[beta, B, Range[0.,1.,0.1]]]<1e-12, "FluFluQueue: stDistr returns wrong sojourn time distribution!"];
