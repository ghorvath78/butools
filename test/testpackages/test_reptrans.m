...
format short g;
disp('========================================')
disp('Testing BuTools function SimilarityMatrix')
...
disp('========================================')
disp('Testing BuTools function TransformToAcyclic')
disp('Input:');
disp('------');
...
disp('========================================')
disp('Testing BuTools function TransformToMonocyclic')
A = [-1, 0, 0; 0, -3, 2; 0, -2, -3];
disp('A = ');
disp(A);
disp('Test:');
...
assert(err<10^-7, 'The original and the transformed matrix are not similar!');
disp('========================================')
disp('Testing BuTools function ExtendToMarkovian')
disp('Input:');
disp('------');
alpha = [0.2,0.3,0.5];
...
disp('========================================')
disp('Testing BuTools function SimilarityMatrixForVectors')
disp('Input:');
disp('------');
