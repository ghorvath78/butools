function TestDMAPPackage ()
	...
	disp('corr = ');
	disp(corr);
	mNm1 = Nm(1,2:end); mNm2 = Nm(2:end,1)';
	...
	disp(D{3});
	disp(D{4});
	disp('m = MarginalMomentsFromDMMAP(D,1):');
	...
	disp('mm = MarginalMomentsFromDMMAP(D,3):');
