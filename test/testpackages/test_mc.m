...
format short g;
disp('========================================')
disp('Testing BuTools function CRPSolve')
disp('Input:');
disp('------');
...
disp('========================================')
disp('Testing BuTools function DRPSolve')
disp('Input:');
disp('------');
...
disp('========================================')
disp('Testing BuTools function CTMCSolve')
disp('Input:');
disp('------');
...
assert(norm(ret*Q)<10^-12, 'The solution does not satisfy ret*Q=0!');
disp('========================================')
disp('Testing BuTools function DTMCSolve')
...
assert(norm(ret*Q-ret)<10^-12, 'The solution does not satisfy ret*Q=ret!');
disp('========================================')
disp('Testing BuTools function CheckGenerator')
disp('Input:');
disp('------');
...
assert(flag==true, 'CheckGenerator did not recognize a valid input!');
disp('========================================')
disp('Testing BuTools function CheckProbMatrix')
disp('Input:');
disp('------');
...
assert(flag==true, 'CheckProbMatrix did not recognize that the input is valid!');
disp('========================================')
disp('Testing BuTools function CheckProbVector')
disp('Input:');
disp('------');
Q = [1.1,-0.1];
disp('Test:');
