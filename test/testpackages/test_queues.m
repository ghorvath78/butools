...
assert(norm(qld-PmfFromMG(alpha, A, (0:1:10)))<10^-12, 'QBDQueue: qlDistr returns wrong queue length distribution!');
...
assert(norm(qld-PmfFromMG(alpha, A, (0:1:10)))<10^12, 'MAPMAP1: qlDistr returns wrong queue length distribution!');
...
assert(norm(qld-CdfFromME(alpha, A, (0.:0.1:1.)))<10^12, 'FluidQueue: qlDistr returns wrong queue length distribution!');
...
assert(norm(qld-CdfFromME(alpha, A, (0.:0.1:1.)))<10^12, 'FluFluQueue: qlDistr returns wrong queue length distribution!');
