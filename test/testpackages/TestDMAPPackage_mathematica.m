TestDMAPPackage[]:=
Module[{D2, H, H1, D0, rNm, err2, moms, m, err1, flag, jmom, H0, rmoms, D3, rNm2, a, Nm3, x, G0, rjmom, G1, rNm3, D1, rNm1, G, D, A, Cm, H2, corr, G3, Nm2, Nm1, rcorr, mm, err, Nm, G2},
	...
	Print[corr];
	Assert[Length[corr]==3 && AllTrue[Flatten[corr],#<1 &] && AllTrue[Flatten[corr],#>-1 &] , "LagCorrelationsFromDMAP returned wrong autocorrelation coefficients!"];
	Print["========================================"];
	...
	Print["corr = "//OutputForm];
	Print[corr];
	Assert[Length[corr]==3 && AllTrue[Flatten[corr],#<1 &] && AllTrue[Flatten[corr],#>-1 &] , "LagCorrelationsFromDRAP returned wrong autocorrelation coefficients!"];
	Print["========================================"];
	...
	Assert[AllTrue[Flatten[Nm],Positive] && Norm[moms-mNm1]<10^-12 && Norm[moms-mNm2]<10^-12 && Norm[corr-cjm]<10^-12 , "Joint moment matrix is invalid!"];
	Print["========================================"];
	...
	Assert[Norm[moms-rmoms]<10^-11 && Abs[corr-rcorr]<10^-12 , "The moments and the correlation returned by DMAP2FromMoments are not the same as given!"];
	Print["========================================"];
	?"SamplesFromDMAP";
	Print["Input:"//OutputForm];
	Print["------"//OutputForm];
